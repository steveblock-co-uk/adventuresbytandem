...
function LoadMapData( filename ) {
  ...
  request.onreadystatechange = function() {
    // IE doesn't support 'this' here
    if (request.readyState == 4) {
      ProcessXML(request.responseXML);
    }
  };
  // This won't work with a file URL on IE
...
*/
  // A hack for CanadaByTandemCA. Add two lines, one thick red, one thin blue.
